...
Below, subsets of the climatologies are plotted for all relevant parameters.
...
clim_tibble_NA_grid <- clim_tibble %>% 
  filter(is.na(parameter)) %>% 
  count(lat, lon, name = "n_NA")
...
clim_tibble_NA_grid %>% 
  ggplot() +
    ...
    geom_raster(aes(lon, lat, fill = n_NA)) +
