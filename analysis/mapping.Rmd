...
Cant_model_average_zonal %>% 
  ...
  geom_contour_filled(breaks = parameters$slabs_Atl[1:12]) +
  geom_contour(breaks = parameters$slabs_Atl[1:12],
               col = "white") +
  geom_text_contour(breaks = parameters$slabs_Atl[1:12],
               col = "white",
               skip = 1) +
...
Cant_model_average_zonal %>%
  ...
  geom_contour(aes(lat, depth, z = gamma_mean),
               breaks = parameters$slabs_Atl[1:12],
               col = "black") +
  geom_text_contour(
