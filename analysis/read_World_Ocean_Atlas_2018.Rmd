...
section_global(WOA18_sal_tem,
               "THETA",
               "Global climatological section")
...
map_climatology(WOA18_sal_tem, "tem")
...
map_climatology(WOA18_sal_tem, "gamma")
...
section_global(WOA18_sal_tem, "gamma",
               "Global climatological section")
...
map_climatology(WOA18_sal_tem_surface, "gamma")
...
section_global(WOA18_sal_tem_surface, "gamma",
               "Global climatological section")
...
```{r read_WOA18_nuts_O2_file_list}
...
for (file in file_list) {
  ...
  # plot maps
  print(map_climatology(WOA18_tibble, parameter))
  
  # plot sections
  print(section_global(
    WOA18_tibble,
    parameter,
