...
## Create Atl-SO-Pac section

```{r Create_Atl_SO_Pac_section, eval=FALSE}
...
section <- section %>%
  mutate(dist_int = distGeo(cbind(lon_180, lat)) / 1e3) %>%
