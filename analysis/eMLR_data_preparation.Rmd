...
The predictor PO~4~* can be calculated according to Clement and Gruber (2018), ie based on oxygen, or according to Gruber et al (2019), based on nitrate.
...
```{r phosphate_star_approach_comparison_oxygen_nitrate, fig.asp=0.4}
...
```{r phosphate_star_approach_comparison_phosphate_nitrate, fig.asp=0.4}
...
```{r phosphate_star_approach_comparison_phosphate_oxygen, fig.asp=0.4}
...
```{r phosphate_star_approach_comparison_oxygen_nitrate_corr, fig.asp=0.4}
...
```{r phosphate_star_approach_comparison, fig.asp=0.4}
