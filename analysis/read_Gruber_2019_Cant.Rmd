...
p_map_cant_inv(cant_inv)

```

```{r G19_cant_pos_inventory_maps}

p_map_cant_pos_inv(cant_inv)
...
p_map_climatology_continous(cant_3d, "cant_pos")
...
p_section_global_continous(cant_3d, "cant_pos")
...
p_section_climatology_regular_continous(cant_3d, "cant_pos")
