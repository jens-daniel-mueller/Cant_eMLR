...
Samples before Jan 01, 2000 were assigned as to the "JGOFS/WOCE" era, else to "GO-SHIP" era.
...
GLODAP  %>%  write_csv(here::here("data/_summarized_data_files",
...
GLODAP_histogram_year %>% 
  ...
  geom_col()+
  geom_vline(xintercept = era_median_year$t_ref)+
...
GLODAP_hovmoeller_year %>% 
  ...
  geom_vline(xintercept = c(2000, 2013))+
  geom_tile()+
...
```{r coverage_maps_era, fig.fullwidth=TRUE}
