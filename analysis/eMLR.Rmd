...
```{r predictor_correlation, eval=FALSE}
...
GLODAP %>% 
  ...
  ggpairs(columns = c("salinity","temperature", "aou", "oxygen", "silicate", "phosphate", "phosphate_star"),
          ggplot2::aes(col = gamma_slab, fill = gamma_slab))+
      scale_fill_viridis_d()+
      scale_color_viridis_d()+
      labs(title = paste("Basin:", i_basin, "| era:", i_era))+
      theme(text = element_text(size=30))

ggsave(here::here("output/figure/eMLR/predictor_correlation",
